...
{
    public class clsMstCostDetailsAir : CommonFeatures
    {
        #region "Save"
        ...
        public int Save(DataSet dsCostDetails, string MJCfk, int CloaseFlag = 0)
        {
            ...
            try
            {
                ...
                _with1.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_EXP_COST_INS";
                var _with2 = _with1.Parameters;
                insCostDetails.Parameters.Add("MASTER_JC_AIR_EXP_FK_IN", Convert.ToInt32(MJCfk)).Direction = ParameterDirection.Input;
                ...
                insCostDetails.Parameters.Add("RETURN_VALUE", OracleDbType.Int32, 10, "MJC_TRN_AIR_EXP_COST_PK").Direction = ParameterDirection.Output;
                insCostDetails.Parameters["RETURN_VALUE"].SourceVersion = DataRowVersion.Current;

                var _with3 = updCostDetails;
                _with3.Connection = objWK.MyConnection;
                _with3.CommandType = CommandType.StoredProcedure;
                _with3.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_EXP_COST_UPD";
                var _with4 = _with3.Parameters;

                updCostDetails.Parameters.Add("MJC_TRN_AIR_EXP_COST_PK_IN", OracleDbType.Int32, 10, "MJC_TRN_AIR_EXP_COST_PK").Direction = ParameterDirection.Input;
                updCostDetails.Parameters["MJC_TRN_AIR_EXP_COST_PK_IN"].SourceVersion = DataRowVersion.Current;

                updCostDetails.Parameters.Add("MASTER_JC_AIR_EXP_FK_IN", MJCfk).Direction = ParameterDirection.Input;
                ...
                _with5.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_EXP_COST_DEL";

                delCostDetails.Parameters.Add("MJC_TRN_AIR_EXP_COST_PK_IN", OracleDbType.Int32, 10, "MJC_TRN_AIR_EXP_COST_PK").Direction = ParameterDirection.Input;
                delCostDetails.Parameters["MJC_TRN_AIR_EXP_COST_PK_IN"].SourceVersion = DataRowVersion.Current;
                ...
                if (RecAfct > 0)
                {
                    ...
                    if (CloaseFlag == 1)
                    {
                        ...
                        _with7.CommandText = objWK.MyUserName + ".JC_COST_CALCULATION_PKG.JC_AIR_EXP_COST_CALC";
                        var _with8 = _with7.Parameters;
                        _with8.Add("MASTER_JC_AIR_EXP_PK_IN", MJCfk).Direction = ParameterDirection.Input;
        ...
        public int SaveImp(DataSet dsCostDetails, string MJCfk, int CloaseFlag = 0)
        {
            ...
            try
            {
                ...
                _with9.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_IMP_COST_INS";
                var _with10 = _with9.Parameters;
                insCostDetails.Parameters.Add("MASTER_JC_AIR_IMP_FK_IN", Convert.ToInt32(MJCfk)).Direction = ParameterDirection.Input;
                ...
                insCostDetails.Parameters.Add("RETURN_VALUE", OracleDbType.Int32, 10, "MJC_TRN_AIR_IMP_COST_PK").Direction = ParameterDirection.Output;
                insCostDetails.Parameters["RETURN_VALUE"].SourceVersion = DataRowVersion.Current;

                var _with11 = updCostDetails;
                _with11.Connection = objWK.MyConnection;
                _with11.CommandType = CommandType.StoredProcedure;
                _with11.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_IMP_COST_UPD";
                var _with12 = _with11.Parameters;

                updCostDetails.Parameters.Add("MJC_TRN_AIR_IMP_COST_PK_IN", OracleDbType.Int32, 10, "MJC_TRN_AIR_IMP_COST_PK").Direction = ParameterDirection.Input;
                updCostDetails.Parameters["MJC_TRN_AIR_IMP_COST_PK_IN"].SourceVersion = DataRowVersion.Current;

                updCostDetails.Parameters.Add("MASTER_JC_AIR_IMP_FK_IN", MJCfk).Direction = ParameterDirection.Input;
                ...
                _with13.CommandText = objWK.MyUserName + ".MJC_TRN_SEA_PKG.MJC_TRN_AIR_IMP_COST_DEL";

                delCostDetails.Parameters.Add("MJC_TRN_AIR_IMP_COST_PK_IN", OracleDbType.Int32, 10, "MJC_TRN_AIR_IMP_COST_PK").Direction = ParameterDirection.Input;
                delCostDetails.Parameters["MJC_TRN_AIR_IMP_COST_PK_IN"].SourceVersion = DataRowVersion.Current;
                ...
                if (RecAfct > 0)
                {
                    ...
                    if (CloaseFlag == 1)
                    {
                        ...
                        _with15.CommandText = objWK.MyUserName + ".JC_COST_CALCULATION_PKG.JC_AIR_IMP_COST_CALC";
                        var _with16 = _with15.Parameters;
                        _with16.Add("MASTER_JC_AIR_IMP_PK_IN", MJCfk).Direction = ParameterDirection.Input;
        ...
        public DataSet getData(string Pk, string Pro = "")
        {
            ...
            try
            {
                ...
                {
                    strSQL.Append(" select mjc_trn_air_imp_pia_pk, v.vendor_id vendor_key, cost_element_id, invoice_number, ");
                    strSQL.Append(" to_char(invoice_date,dateformat) invoice_date, currency_mst_fk, actual_amt ACTUAL_AMT, tax_percentage, ");
                    strSQL.Append(" tax_amt, estimated_amt, actual_amt-estimated_amt diff_amt, decode(j.charge_basis,1,'Ch. Wt.',2,'Gr. Wt.') CHARGE_BASIS1, vendor_mst_fk, ");
                    strSQL.Append(" cost_element_mst_fk, attached_file_name, 'false' Del, j.charge_basis from mjc_trn_air_imp_pia j, ");
                    ...
                    strSQL.Append(" and j.vendor_mst_fk = v.vendor_mst_pk and master_jc_air_imp_fk = " + Pk);
                    strSQL.Append(" order by mjc_trn_air_imp_pia_pk ");
                    //Export
                }
                else
                {
                    strSQL.Append(" select mjc_trn_air_exp_pia_pk, v.vendor_id vendor_key, cost_element_id, invoice_number, ");
                    strSQL.Append(" to_char(invoice_date,dateformat) invoice_date, currency_mst_fk, actual_amt ACTUAL_AMT, tax_percentage, ");
                    strSQL.Append(" tax_amt, estimated_amt, actual_amt-estimated_amt diff_amt, decode(j.charge_basis,1,'Ch. Wt.',2,'Gr. Wt.') CHARGE_BASIS1, vendor_mst_fk, ");
                    strSQL.Append(" cost_element_mst_fk, attached_file_name, 'false' Del, j.charge_basis from mjc_trn_air_exp_pia j, ");
                    strSQL.Append(" currency_type_mst_tbl curr, cost_element_mst_tbl c, vendor_mst_tbl v ");
                    strSQL.Append(" where j.cost_element_mst_fk = c.cost_element_mst_pk and j.currency_mst_fk = curr.currency_mst_pk ");
                    strSQL.Append(" and j.vendor_mst_fk = v.vendor_mst_pk and master_jc_air_exp_fk = " + Pk);
                    strSQL.Append(" order by mjc_trn_air_exp_pia_pk ");
                }
        ...
        public DataSet FetchCostDetailDataExp(string MstJcPK = "0", string pro = "", int baseCurrency = 0)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(pro) == 2)
                {
                    strSQL.Append("SELECT MJC.MJC_TRN_AIR_IMP_COST_PK,");
                    strSQL.Append("       MJC.MASTER_JC_AIR_IMP_FK,");
                    ...
                    strSQL.Append("  FROM MJC_TRN_AIR_IMP_COST  MJC,");
                    ...
                    strSQL.Append(" WHERE MJC.MASTER_JC_AIR_IMP_FK= MJOB.MASTER_JC_AIR_IMP_PK");
                    ...
                    strSQL.Append("   AND MJOB.MASTER_JC_AIR_IMP_PK = " + MstJcPK);
                }
                else
                {
                    strSQL.Append("SELECT MJC.MJC_TRN_AIR_EXP_COST_PK,");
                    strSQL.Append("       MJC.MASTER_JC_AIR_EXP_FK,");
                    strSQL.Append("       VMT.VENDOR_MST_PK,");
                    strSQL.Append("       CMT.COST_ELEMENT_MST_PK,");
                    strSQL.Append("       MJC.VENDOR_KEY,");
                    strSQL.Append("       CMT.COST_ELEMENT_ID,");
                    ...
                    strSQL.Append("       MJC.LOCATION_MST_FK,");
                    strSQL.Append("       MJC.CURRENCY_MST_FK");
                    strSQL.Append("  FROM MJC_TRN_AIR_EXP_COST  MJC,");
                    strSQL.Append("       MASTER_JC_AIR_EXP_TBL MJOB,");
                    strSQL.Append("       VENDOR_MST_TBL        VMT,");
                    strSQL.Append("       COST_ELEMENT_MST_TBL  CMT,");
                    strSQL.Append("       CURRENCY_TYPE_MST_TBL CURR,");
                    strSQL.Append("       LOCATION_MST_TBL      LMT");
                    strSQL.Append(" WHERE MJC.MASTER_JC_AIR_EXP_FK= MJOB.MASTER_JC_AIR_EXP_PK");
                    strSQL.Append("   AND MJC.COST_ELEMENT_MST_FK = CMT.COST_ELEMENT_MST_PK");
                    strSQL.Append("   AND MJC.VENDOR_MST_FK = VMT.VENDOR_MST_PK");
                    strSQL.Append("   AND MJC.CURRENCY_MST_FK = CURR.CURRENCY_MST_PK");
                    strSQL.Append("   AND MJC.LOCATION_MST_FK = LMT.LOCATION_MST_PK");
                    strSQL.Append("   AND MJOB.MASTER_JC_AIR_EXP_PK = " + MstJcPK);
                }
