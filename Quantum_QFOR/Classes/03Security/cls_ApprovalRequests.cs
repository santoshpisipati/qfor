...
namespace Quantum_QFOR
{
    ...
    public class cls_ApprovalRequests : CommonFeatures
    {
        ...
        #endregion "SendMessageNew "

        #region "SendMessageNew "

        public string SendMessageJMF(long lngCreatedBy, DataSet dsUserFks, string strDocId, long lngLocFk, System.DateTime salecaldate, long SenderFk = 0, string strSpecificURL = "", string JobPk = "0", string Reminderpk = "0", long Biz_Type = 0, long Process_Type = 0,
         long strpk = 0, string TypeFlag = "", string strReqDocId = "", int ApprovalFlg = 0, int ReqByUserFk = 0)
        {
            string functionReturnValue = null;
            DataSet dsMsg = new DataSet();
            DataSet dsDoc = null;
                    ...
                    if (dsUserFks.Tables[0].Rows.Count > 0)
                    {
                        for (intSenderCnt = 0; intSenderCnt <= dsUserFks.Tables[0].Rows.Count - 1; intSenderCnt++)
                        {
                            if (!(string.IsNullOrEmpty(dsUserFks.Tables[0].Rows[intSenderCnt]["USER_MST_PK"].ToString())))
                            {
                                ...
                                {
                                    lngPkValue = Convert.ToInt32(dsUserFks.Tables[0].Rows[intSenderCnt]["USER_MST_PK"]);
            ...
            try
            {
                ...
                if (dsUserFks.Tables[0].Rows.Count > 0)
                {
                    for (int intSenderCnt = 0; intSenderCnt <= dsUserFks.Tables[0].Rows.Count - 1; intSenderCnt++)
                    {
                        if (!(string.IsNullOrEmpty(dsUserFks.Tables[0].Rows[intSenderCnt]["USER_MST_PK"].ToString())))
                        {
                            if ((Convert.ToInt32(dsUserFks.Tables[0].Rows[intSenderCnt]["USER_MST_PK"].ToString())) > 0)
                            {
        ...
        public string SendExternalMailEcomm(string CustRegFK, string strDocId, string Company_Name = "", string Emailid = "", string Userid = "")
        {
            ...
            try
            {
                ...
                Int16 i = default(Int16);
                Int16 j = default(Int16);
                Create_By = Convert.ToString(HttpContext.Current.Session["USER_PK"]);
                if (!string.IsNullOrEmpty(Emailid))
                {
                    objMail = new MailMessage();
                    objMail.From = new MailAddress(M_SEND_USERNAME, M_SEND_NAME);
        ...
        #endregion " SendMessageProfitability "
        ...
        public DataSet FetchCBJCDetails(string lngPkValue, string Percentage = "0")
        {
            ...
            if (Convert.ToInt32(lngPkValue) > 0)
            {
        ...
        #endregion " Fetch TransporterNote Details"
        ...
        #endregion " Fetch Jobcard Details"
        ...
        #endregion "FetchForeignAgentDetails "
        ...
        #endregion "FetchSeaCustContract "
        ...
        #endregion "FetchAirCustContract "
        ...
        #endregion "FetchAirLineContract "
        ...
        #endregion "FetchWareHouseContract "
        ...
        #endregion "FetchTransPortContract "
        ...
        #endregion "FetchTransportContractAir "
        ...
        #endregion "Fetch Doc Details by Activity"
        ...
        #endregion "FetchDocDetailsForProfitMargin "
        ...
        #endregion " Fetch UserName & Location Details"
        ...
        #endregion "DisplayMessageDetail"
        ...
        public long SaveApprovalMsg(DataSet dsMessage)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(_with14.ExecuteNonQuery()) == 1)
                {
        ...
        #endregion " Save Approval Messages"
        ...
        #endregion " Fetch Messages - On Login"
        ...
        #endregion " Save Direct Single user"
        ...
        public string ConvertHTML(string strBody)
        {
            ...
            {
                MsgText = strBody.Replace(System.Environment.NewLine, "~");
                MsgText = MsgText.Replace(System.Environment.NewLine, "~");
                        ...
                        for (intSenderCnt = 0; intSenderCnt <= dsUserFks.Tables[0].Columns.Count - 1; intSenderCnt++)
                        {
                            if (!(string.IsNullOrEmpty(dsUserFks.Tables[0].Rows[0][intSenderCnt].ToString())))
                            {
                                if ((Convert.ToInt32(dsUserFks.Tables[0].Rows[0][intSenderCnt])) > 0)
                                {
                                    ...
                                    Mail_obj.M_MAIL_BODY = strMsgBody + strPageURL + strFooter;
                                    Mail_obj.Create_by = HttpContext.Current.Session["USER_PK"].ToString();
                                ...
                                if ((Convert.ToInt32(dsUserFks.Tables[0].Rows[0][intSenderCnt])) > 0)
                                {
                                    ...
                                    if (dsMsg.Tables[1].Rows.Count > 0)
                                    {
                                        ...
                                        if (ApprovalFlg == 0)
                                        {
                                            ...
                                            Mail_obj.M_MAIL_SUBJECT = strMsgSub;
                                            Mail_obj.M_MAIL_BODY = strMsgBody + strPageURLforexternal;
                                            Mail_obj.Create_by = HttpContext.Current.Session["USER_PK"].ToString();
        ...
        #endregion " Notiy Customer Email"
    }
}