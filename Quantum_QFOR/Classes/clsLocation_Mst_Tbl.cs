    ...
    public class clsLocation_Mst_Tbl : CommonFeatures
    {
        ...
        public bool UpdateFileName(long Location_Type_Fk, string strFileName, Int16 Flag)
        {
            if (strFileName.Trim().Length > 0)
            {
                ...
                {
                    RemQuery = " UPDATE AAGENT_COMM_SETUP_TBL AGT SET AGT.ATTACHED_FILE_NAME='" + DBNull.Value + "'";
                    RemQuery += " WHERE AGT.LOCATION_TYPE_MST_FK= " + Location_Type_Fk;
                    try
                    {
                        objwk.OpenConnection();
        ...
        public ArrayList Delete(ArrayList DeletedRow)
        {
            ...
            try
            {
                ...
                for (i = 0; i <= DeletedRow.Count - 1; i++)
                {
                    ...
                    arrRowDetail = Strings.Split(Convert.ToString(DeletedRow[i]), ",");
        ...
        public ArrayList Insert_Agent_Mst(DataSet M_DataSet,  OracleCommand cmd)
        {
            ...
            try
            {
                ...
                _with16.Add("AGENT_NAME_IN", getDefault(Convert.ToString(M_DataSet.Tables[0].Rows[0]["OFFICE_NAME"]), DBNull.Value)).Direction = ParameterDirection.Input;
                ...
                _with16.Add("IATA_CODE_IN", DBNull.Value).Direction = ParameterDirection.Input;
                ...
                _with16.Add("ACCOUNT_NO_IN", DBNull.Value).Direction = ParameterDirection.Input;
                ...
                _with16.Add("VAT_NO_IN", DBNull.Value).Direction = ParameterDirection.Input;
                ...
                _with16.Add("EXP_PROFIT_PER_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("EXP_COMM_PER_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("IMP_PROFIT_PER_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("IMP_COMM_PER_IN", DBNull.Value).Direction = ParameterDirection.Input;
                ...
                _with16.Add("ADM_ADDRESS_2_IN", getDefault(Convert.ToString(M_DataSet.Tables[0].Rows[0]["address_line2"]), DBNull.Value)).Direction = ParameterDirection.Input;
                _with16.Add("ADM_ADDRESS_3_IN", getDefault(Convert.ToString(M_DataSet.Tables[0].Rows[0]["address_line3"]), DBNull.Value)).Direction = ParameterDirection.Input;
                _with16.Add("ADM_CITY_IN", Convert.ToString(M_DataSet.Tables[0].Rows[0]["city"])).Direction = ParameterDirection.Input;
                _with16.Add("ADM_ZIP_CODE_IN", getDefault(Convert.ToString(M_DataSet.Tables[0].Rows[0]["zip"]), DBNull.Value)).Direction = ParameterDirection.Input;
                ...
                _with16.Add("ADM_SALUTATION_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_CONTACT_PERSON_IN", getDefault(Convert.ToString(M_DataSet.Tables[0].Rows[0]["office_name"]), DBNull.Value)).Direction = ParameterDirection.Input;
                _with16.Add("ADM_PHONE_NO_1_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_PHONE_NO_2_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_FAX_NO_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_EMAIL_ID_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_URL_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("ADM_SHORT_NAME_IN", DBNull.Value).Direction = ParameterDirection.Input;
                //SUMI START
                _with16.Add("REMARKS_IN", DBNull.Value).Direction = ParameterDirection.Input;
                //END
                //' CORRESPONDENCE
                _with16.Add("COR_ADDRESS_1_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_ADDRESS_2_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_ADDRESS_3_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_CITY_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_ZIP_CODE_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_COUNTRY_MST_FK_IN", DBNull.Value).Direction = ParameterDirection.Input;

                _with16.Add("COR_SALUTATION_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_CONTACT_PERSON_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_PHONE_NO_1_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_PHONE_NO_2_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_FAX_NO_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_EMAIL_ID_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_URL_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("COR_SHORT_NAME_IN", DBNull.Value).Direction = ParameterDirection.Input;
                //' BILLING
                _with16.Add("BILL_ADDRESS_1_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_ADDRESS_2_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_ADDRESS_3_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_CITY_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_ZIP_CODE_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_COUNTRY_MST_FK_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_SALUTATION_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_CONTACT_PERSON_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_PHONE_NO_1_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_PHONE_NO_2_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_FAX_NO_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_EMAIL_ID_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_URL_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("BILL_SHORT_NAME_IN", DBNull.Value).Direction = ParameterDirection.Input;

                // ============= Parameters for Freight Elements =========================================
                _with16.Add("FREIGHT_FK_EXP_PS_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("FREIGHT_FK_EXP_CM_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("FREIGHT_FK_IMP_PS_IN", DBNull.Value).Direction = ParameterDirection.Input;
                _with16.Add("FREIGHT_FK_IMP_CM_IN", DBNull.Value).Direction = ParameterDirection.Input;
                // =======================================================================================
        ...
        public Int32 MonthlyCuttoffSave( DataSet M_DataSet,  OracleTransaction TRAN, Int32 LocationPK)
        {
            ...
            try
            {
                ...
                if (M_DataSet.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (!Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_CLOSING_DAY"]))
                        {
                            ...
                            _with26.Add("MONTH_YEAR_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_YEAR"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_YEAR"])).Direction = ParameterDirection.Input;
                            _with26.Add("MONTH_CLOSING_DAY_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_CLOSING_DAY"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_CLOSING_DAY"])).Direction = ParameterDirection.Input;
                            _with26.Add("STATUS_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["STATUS_PK"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["STATUS_PK"])).Direction = ParameterDirection.Input;
                            ...
                            _with28.Clear();
                            _with28.Add("MONTH_END_PK_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_END_PK"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_END_PK"])).Direction = ParameterDirection.Input;
                            _with28.Add("LOCATION_MST_FK_IN", LocationPK).Direction = ParameterDirection.Input;
                            _with28.Add("MONTH_YEAR_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_YEAR"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_YEAR"])).Direction = ParameterDirection.Input;
                            _with28.Add("MONTH_CLOSING_DAY_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_CLOSING_DAY"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_CLOSING_DAY"])).Direction = ParameterDirection.Input;
                            _with28.Add("VERSION_NO_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["VERSION_NO"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["VERSION_NO"])).Direction = ParameterDirection.Input;
                            _with28.Add("STATUS_IN", (Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["STATUS_PK"]) ? DBNull.Value : M_DataSet.Tables[0].Rows[RowCnt]["STATUS_PK"])).Direction = ParameterDirection.Input;
                            ...
                            MonthPK = Convert.ToString(Information.IsDBNull(M_DataSet.Tables[0].Rows[RowCnt]["MONTH_END_PK"]) ? 0 : M_DataSet.Tables[0].Rows[RowCnt]["MONTH_END_PK"]);
