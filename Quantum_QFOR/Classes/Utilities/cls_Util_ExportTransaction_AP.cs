...
{
    public class cls_Util_ExportTransaction_AP
    {
        #region "Enhance Search + Lookup Search Block"
        public object Fetch_Export_AP(string strCond)
        {
            ...
            try
            {
                ...
                selectCommand.CommandText = objWF.MyUserName + ".EN_UTIL_EXPORT_WIZARD_PKG.SP_GET_EXPORT_AP_FORMS";
        ...
        #region "fn_Get_Export_TableLevels"
