...
namespace Quantum_QFOR
{
    ...
    public class cls_DEPARTMENT_MST_TBL : CommonFeatures
    {
        ...
        /// <returns></returns>
        public DataSet FetchAll(Int16 DepartmentPK, string DepartmentID, string DepartmentName, string SearchType, string strColumnName, Int32 CurrentPage, Int32 TotalPage, Int16 SortCol, Int16 IsActive, bool blnSortAscending,
        Int32 flag)
        {
        ...
        /// <param name="TotalPage">The total page.</param>
        /// <returns></returns>
        public DataSet FetchDesignTrn(long DesignTRNPK, Int32 CurrentPage, Int32 TotalPage)
        {
            Int32 last = default(Int32);
            Int32 start = default(Int32);
            string strSQL = null;
