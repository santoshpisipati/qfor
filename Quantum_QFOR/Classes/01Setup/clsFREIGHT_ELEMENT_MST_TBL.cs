...
namespace Quantum_QFOR
{
    ...
    public class clsFreight_Element_Mst_Tbl : CommonFeatures
    {
                ...
                for (i = 0; i <= M_DataSet.Tables[0].Rows.Count - 1; i++)
                {
                    ...
                    if (M_DataSet.Tables[0].Rows[i][6] == "1")
                    {
                        ...
                        if (string.IsNullOrEmpty(M_DataSet.Tables[0].Rows[i][2].ToString()))
                        {
                            ...
                            {
                                _with9.Add("FREIGHT_ELEMENT_FK_IN", DBNull.Value).Direction = ParameterDirection.Input;
                            }
                        ...
                        else
                        {
                            ...
                            {
                                _with11.Add("FREIGHT_ELEMENT_FK_IN", DBNull.Value).Direction = ParameterDirection.Input;
                            }
                            // .Add("FREIGHT_ELEMENT_FK_IN", M_DataSet.Tables(0).Rows(i).Item(3)).Direction = ParameterDirection.Input
                    ...
                    else
                    {
                        if (!string.IsNullOrEmpty(M_DataSet.Tables[0].Rows[i][2].ToString()))
                        {
                            ...
                            {
                                _with13.Add("FREIGHT_ELEMENT_FK_IN", DBNull.Value).Direction = ParameterDirection.Input;
                            }
        ...
        #endregion "Save Freight Element"
        ...
        #endregion "Fetch Freight Element Into Parameters"
        ...
        #endregion "Fetch Freight Elements for Formula Form"
        ...
        #endregion "Fetch Freight Pop Header"
        ...
        #endregion "Fetch Surcharge Pop Header"
        ...
        #endregion "Fetch Local Charges Tree "
        ...
        public ArrayList SaveFreightPopUp(DataSet M_DataSet, long ChargePK, string FreightPKs)
        {
            ...
            try
            {
                DeleteCharge(Convert.ToInt64(M_DataSet.Tables[0].Rows[0]["FREIGHT_ELEMENT_FK"]), Convert.ToInt64(M_DataSet.Tables[0].Rows[0]["FREIGHT_TYPE"]));
        ...
        public string DeleteCharge(long ChargePK, long ChargeType)
        {
            ...
            try
            {
                ...
                if (RcdCnt > 0)
                {
                    ...
                    return Objwk.ExecuteCommands(sb1.ToString()).ToString();
                }
            }
            catch (OracleException sqlExp)
            {
        ...
        #endregion "Save Local Charge PopUp"
        ...
        #endregion "Get default Currency as USD"
        ...
        #endregion "Get AIF Charge Element"
    }
}