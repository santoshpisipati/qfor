...
namespace Quantum_QFOR
{
    public class clsRegionDetails : CommonFeatures
    {
        ...
        #endregion " Fetch Selected Region Ports "
        ...
        public string FetchLocation(string strCond)
        {
            ...
            if (arr.Length > 4)
                CREDIT_FLAG = Convert.ToString(arr.GetValue(4));
            try
            {
        ...
        #endregion " Available Ports For a Country "
        ...
        #endregion " Available Ports For a Region "
        ...
        #endregion "Get Location Id and Location Name when Sending Location Pk"
    }
}