    ...
    (function (ApplicationInsights) {
        var Util = (function () {
            ...
            Util.toISOStringForIE8 = function (date) {
                if (Util.isDate(date)) {
                    if (DateTime.prototype.toISOString) {
            ...
            (function (Common) {
                ...
                var Envelope = (function (_super) {
                    ...
                    function Envelope(data, name) {
                        ...
                        this.name = name;
                        this.data = data;
                        this.time = ApplicationInsights.Util.toISOStringForIE8(new DateTime());
                        this.aiDataContract = {
                            time: true,
                            iKey: true,
                            name: true,
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            "use strict";
            var HttpContext.Current.Session = (function () {
                function HttpContext.Current.Session() {
                }
                return HttpContext.Current.Session;
            })();
            Context.HttpContext.Current.Session = HttpContext.Current.Session;
            var _SessionManager = (function () {
                function _SessionManager(config, sessionHandler) {
                    ...
                    this.automaticSession = new HttpContext.Current.Session();
                }
                _SessionManager.prototype.update = function () {
                    ...
                    if (acquisitionExpired || renewalExpired) {
                        ...
                        this.automaticSession.renewalDate = +new DateTime;
                ...
                _SessionManager.prototype.initializeAutomaticSessionWithData = function (sessionData) {
                    ...
                    try {
                        if (params.length > 1) {
                            var acq = +params[1];
                            this.automaticSession.acquisitionDate = +new DateTime(acq);
                            this.automaticSession.acquisitionDate = this.automaticSession.acquisitionDate > 0 ? this.automaticSession.acquisitionDate : 0;
                        }
                        if (params.length > 2) {
                            var renewal = +params[2];
                            this.automaticSession.renewalDate = +new DateTime(renewal);
                ...
                _SessionManager.prototype.renew = function () {
                    ...
                    if (!ApplicationInsights.Util.canUseLocalStorage()) {
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(1 /* WARNING */, "Browser does not support local storage. HttpContext.Current.Session durations will be inaccurate.");
                    }
                };
                _SessionManager.prototype.setCookie = function (guid, acq, renewal) {
                    var acquisitionExpiry = acq + this.config.sessionExpirationMs();
                    var renewalExpiry = renewal + this.config.sessionRenewalMs();
                    var cookieExpiry = new DateTime();
        ...
        var TelemetryContext = (function () {
            function TelemetryContext(config) {
                ...
                if (typeof window !== 'undefined') {
                    ...
                    this.session = new ApplicationInsights.Context.HttpContext.Current.Session();
            ...
            TelemetryContext._sessionHandler = function (tc, sessionState, timestamp) {
                ...
                sessionStateEnvelope.time = ApplicationInsights.Util.toISOStringForIE8(new DateTime(timestamp));
        ...
        (function (Telemetry) {
            ...
            var PageVisitTimeManager = (function () {
                ...
                PageVisitTimeManager.prototype.stopPageVisitTimer = function () {
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            var pageVisitEndTime = DateTime.now();
            ...
            var PageVisitData = (function () {
                function PageVisitData(pageName, pageUrl) {
                    this.pageVisitStartTime = DateTime.now();
    ...
    (function (ApplicationInsights) {
        ...
        var AppInsights = (function () {
            ...
            AppInsights.prototype.trackPageViewInternal = function (name, url, properties, measurements) {
                ...
                if (ApplicationInsights.Telemetry.PageViewPerformance.isPerformanceTimingSupported()) {
                    ...
                    durationMs = ApplicationInsights.Telemetry.PageViewPerformance.getDuration(startTime, +new DateTime);
        ...
        var Timing = (function () {
            ...
            Timing.prototype.start = function (name) {
                ...
                this._events[name] = +new DateTime;
            };
