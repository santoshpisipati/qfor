...
intellisense.annotate(jQuery, {
  ...
  'inArray': function() {
    ...
    ///   <param name="fromIndex" type="Int32">The index of the array at which to begin the search. The default is 0, which will search the whole array.</param>
    ///   <returns type="Int32" />
    /// </signature>
  },
  'isArray': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'attr': function() {
    ...
    ///   <param name="value" type="Int32">A value to set for the attribute.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set one or more attributes for the set of matched elements.</summary>
  ...
  'css': function() {
    ...
    ///   <param name="value" type="Int32">A value to set for the property.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set one or more CSS properties for the set of matched elements.</summary>
  ...
  'delay': function() {
    ...
    ///   <param name="duration" type="Int32">An integer indicating the number of milliseconds to delay execution of the next item in the queue.</param>
    ///   <param name="queueName" type="String">A string containing the name of the queue. Defaults to fx, the standard effects queue.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'eq': function() {
    ...
    ///   <param name="index" type="Int32">Zero-based index of the element to match.</param>
    /// </signature>
    /// <signature>
    ///   <summary>Select the element at index n within the matched set.</summary>
    ///   <param name="-index" type="Int32">Zero-based index of the element to match, counting backwards from the last element.</param>
    /// </signature>
  },
  'error': function() {
    /// <signature>
  ...
  'fadeTo': function() {
    ...
    ///   <param name="duration" type="Int32">A string or number determining how long the animation will run.</param>
    ///   <param name="opacity" type="Int32">A number between 0 and 1 denoting the target opacity.</param>
    ///   <param name="complete" type="Function">A function to call once the animation is complete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'get': function() {
    ...
    ///   <param name="index" type="Int32">A zero-based integer indicating which element to retrieve.</param>
  ...
  'gt': function() {
    ...
    ///   <param name="index" type="Int32">Zero-based index.</param>
    /// </signature>
  },
  'has': function() {
    /// <signature>
  ...
  'height': function() {
    ...
    ///   <param name="value" type="Int32">An integer representing the number of pixels, or an integer with an optional unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS height of every matched element.</summary>
  ...
  'scrollLeft': function() {
    ...
    ///   <param name="value" type="Int32">An integer indicating the new position to set the scroll bar to.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'scrollTop': function() {
  ...
  'slice': function() {
    ...
    ///   <param name="start" type="Int32">An integer indicating the 0-based position at which the elements begin to be selected. If negative, it indicates an offset from the end of the set.</param>
    ///   <param name="end" type="Int32">An integer indicating the 0-based position at which the elements stop being selected. If negative, it indicates an offset from the end of the set. If omitted, the range continues until the end of the set.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'slideDown': function() {
  ...
  'width': function() {
    ...
    ///   <param name="value" type="Int32">An integer representing the number of pixels, or an integer along with an optional unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of matched elements.</summary>
